...
import static org.jooq.generated.wuan.Tables.USER;
...
import org.jooq.generated.wuan.tables.records.UserRecord;
...
public class JooqTutorialsTest extends AbstractDataAccessLayerTest {
  ...
  @Sql(
      statements = {
        "INSERT INTO wuan.user (id, username, password) VALUES (1, 'testUserA','5EUX1AIlV09n2o')",
        "INSERT INTO wuan.user (id, username, password) VALUES (2, 'testUserB','lbHHwHjTzpOiRHTs')"
      })
  void queryWithDsl() {
  ...
  @Sql(
      statements = {
        "INSERT INTO wuan.user (id, username, password) VALUES (1, 'testUserA','5EUX1AIlV09n2o')",
        "INSERT INTO wuan.user (id, username, password) VALUES (2, 'testUserB','lbHHwHjTzpOiRHTs')",
        "INSERT INTO wuan.user (id, username, password) VALUES (3, 'testUserC','yF25WscLYmA8')",
        "INSERT INTO wuan.user (id, username, password) VALUES (4, 'testUserD','yF25WscLYmA8')",
        "INSERT INTO wuan.user (id, username, password) VALUES (5, 'testUserE','x60FelJjyd0B')"
      })
  void pagingQuery() {
    List<User> users =
  ...
  @Sql(
      statements = {
        "INSERT INTO wuan.user (id, username, password) VALUES (1, 'testUserA','a')",
        "INSERT INTO wuan.user (id, username, password) VALUES (2, 'testUserB','b')",
        "INSERT INTO wuan.user (id, username, password) VALUES (3, 'testUserC','c')",
        "INSERT INTO wuan.user (id, username, password) VALUES (4, 'testUserD','c')",
        "INSERT INTO wuan.user (id, username, password) VALUES (5, 'testUserE','c')"
      })
  ...
  @Sql(
      statements = {
        ...
        "INSERT INTO wuan.user (id, username, password) VALUES (2, 'testUserB','b')",
        "INSERT INTO wuan.user (id, username, password) VALUES (3, 'testUserC','c')",
        "INSERT INTO wuan.user (id, username, password) VALUES (4, 'testUserD','e')",
        "INSERT INTO wuan.user (id, username, password) VALUES (5, 'testUserE','f')"
      })
