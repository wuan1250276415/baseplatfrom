...
public class SortByDALTest extends AbstractDataAccessLayerTest {
  ...
  @Sql(
      statements = {
        ...
        "INSERT INTO wuan.user (id, username,password) VALUES (3, 'testC','qFVVFvPqs291k10')",
      })
  ...
  @Sql(
      statements = {
        "INSERT INTO wuan.user (id, username, password) VALUES (1, 'testA','1')",
        "INSERT INTO wuan.user (id, username,password) VALUES (2, 'testB','2')",
        "INSERT INTO wuan.user (id, username,password) VALUES (3, 'testC','3')",
        "INSERT INTO wuan.user (id, username,password) VALUES (4, 'testD','3')",
      })
